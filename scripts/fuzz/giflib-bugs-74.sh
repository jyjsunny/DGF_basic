...
CFLAGS="-fprofile-arcs -ftest-coverage -distance=$TMP_DIR/distance.cfg.txt" CXXFLAGS="-fprofile-arcs -ftest-coverage -distance=$TMP_DIR/distance.cfg.txt" ../configure --disable-shared --prefix=`pwd`
make clean; make -j4
